  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        title="Admin Notes"
        className="fixed bottom-6 left-6 z-50 w-12 h-12 rounded-full bg-[#1F4E79] text-white shadow-lg flex items-center justify-center hover:bg-[#2E75B6] transition-colors"
      >
      ...
      {/* Notes panel */}
      {open && (
        <div className="fixed bottom-20 left-6 z-50 w-80 bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col max-h-[70vh]">
          {/* Header */}
